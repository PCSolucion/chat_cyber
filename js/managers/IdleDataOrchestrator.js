      ...
      const allScreens = [
        {
          ...
          isValid: () =>
            ...
            displayStats.sessionDuration !== "00:00:00",
        },
        {
          type: "leaderboard",
          title: "MÁS ACTIVOS",
        ...
        },
        {
          ...
          isValid: (s) =>
            s.data.totalActive > 0 || s.data.topStreaks.length > 0,
        },
        {
        ...
        },
        {
          ...
          title: "TIEMPO TOTAL",
          data: this.statsService.getTopWatchTime
            ? this.statsService.getTopWatchTime("total", 10)
            : [],
          isValid: (s) => s.data && s.data.length > 0,
        },
        {
        ...
        },
        {
          ...
          data: this.statsService.getTopSubscribers
            ? this.statsService.getTopSubscribers(20)
            : [],
          isValid: (s) => s.data && s.data.length > 0,
        },
      ];
